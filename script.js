...
(function () {
  ...
  const scrollVideo = document.querySelector('#scroll-video .scroll-video__media');
  if (scrollVideo && 'IntersectionObserver' in window) {
    let hasPlayed = false;
